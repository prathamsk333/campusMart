...
export default function AddItemPage() {
  ...
  const { mutate } = useMutation({
    mutationFn: (itemDetails: any) => {
      console.log("Sending itemDetails to server:", itemDetails);
      return createItem(itemDetails);
    },
    onSuccess: (data) => {
  ...
  function onSubmit(data: AddItemFormValues) {
    ...
    try {
      ...
      const itemDetails = {
        ...
        startingPrice: Number(data.minBidPrice),
        biddingStartTime: new Date(data.startTime).toISOString(),
        biddingEndTime: new Date(data.endTime).toISOString(),
      ...
      console.log("Form data prepared:", itemDetails);
